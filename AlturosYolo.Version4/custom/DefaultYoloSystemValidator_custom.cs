...
{
    public class DefaultYoloSystemValidator_custom : IYoloSystemValidator_custom
    {
        public SystemValidationReport_custom Validate()
        {
            var report = new SystemValidationReport_custom();
